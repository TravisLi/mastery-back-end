...
public class SchoolTracsConst {
	...
	public static final String FAC_URL = REST_URL + "/facility";
	public static final String FAC_REQ_URL = FAC_URL + READ_URL;
	public static final String CUST_URL = REST_URL + "/customer";
	public static final String CUST_REQ_URL = CUST_URL + READ_URL;
	public static final String CUST_UPD_URL = CUST_URL + "/update";
	public static final String ACT_URL = REST_URL + "/activity";
	public static final String ACT_REQ_URL = ACT_URL + READ_URL;
	public static final String ACT_STAFF_URL = REST_URL + "/activityStaff";
	public static final String ACT_STAFF_REQ_URL = ACT_STAFF_URL + READ_URL;
	public static final String ACT_FAC_URL = REST_URL + "/activityFacility";
	public static final String ACT_FAC_REQ_URL = ACT_FAC_URL + READ_URL;
	public static final String STAFF_URL = REST_URL + "/staff";
	public static final String STAFF_REQ_URL = STAFF_URL + READ_URL;
	public static final String JOURNAL_URL = REST_URL + "/journal";
	public static final String JOURNAL_REQ_URL = JOURNAL_URL + READ_URL;
	public static final String INVOICE_URL = REST_URL + "/Invoice";
	public static final String INVOICE_REQ_URL = INVOICE_URL + READ_URL;
	public static final String INVOICE_ITEM_URL = REST_URL + "/InvoiceItem";
	public static final String INVOICE_ITEM_REQ_URL = INVOICE_ITEM_URL + READ_URL;
